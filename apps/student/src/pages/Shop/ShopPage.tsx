...
export default function ShopPage() {
  ...
  const balance = dashboard?.user.currencyBalance || 0
  ...
  return (
    <div className="space-y-4 animate-fade-in">
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="rounded-xl px-4 py-2 crystal-glass">
          ...
          <div className="space-y-4">
            ...
            {balance < selectedItem.price && (
              <div className="p-3 bg-amber-50 rounded-xl text-sm text-amber-700">
                You need {selectedItem.price - balance} more coins to purchase this item.
              </div>
            )}
...
function ShopItemCard({ item, balance, onSelect }: ShopItemCardProps) {
  ...
  return (
    <Card
      interactive={!item.isOwned}
      padding="md"
      className={cn(item.isOwned && 'opacity-60')}
      onClick={onSelect}
    >
      {/* Item preview */}
      <div

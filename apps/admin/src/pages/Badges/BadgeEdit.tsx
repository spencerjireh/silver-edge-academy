...
import { useBadge, useUpdateBadge } from '@/hooks/queries/useBadges'
...
export default function BadgeEdit() {
  ...
  useSetPageMeta({ entityLabel: badge?.name })
    ...
    <div className="max-w-2xl">
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="flex items-center justify-end gap-3 pt-4">
          ...
          <Button type="submit" isLoading={updateBadge.isPending}>Save Changes</Button>
        </div>
      </form>
    </div>
  )
